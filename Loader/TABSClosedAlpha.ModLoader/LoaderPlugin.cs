...
namespace TABSClosedAlpha
{
    ...
    public sealed class LoaderRuntime
    {
        ...
        {
            var conflictFree = candidates.Where(candidate => !candidates.Any(other => !System.Object.ReferenceEquals(candidate, other) && (candidate.Metadata.Conflicts.Contains(other.Metadata.Id) || other.Metadata.Conflicts.Contains(candidate.Metadata.Id)))).ToList();
